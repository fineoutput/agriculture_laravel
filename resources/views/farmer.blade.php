                                        ...
                                        <div class="col-12">
                                            <div class="bd-services__details-wrapper mb-60">
                                                <div class="bd-services__details-thumb w-img mb-50">
                                                    <img src="{{ asset('assets/frontend/img/service-details-01.jpg') }}" alt="service-thumb">
                                                </div>
                                                <div class="bd-services__details-content mb-40">
                                                        ...
                                                        <div class="bd-services__features-grid">
                                                            <div class="bd-services__features-item">
                                                                <div class="bd-services__features-icon">
                                                                    <span><img src="{{ asset('assets/frontend/img/service/details/breed-icon-01.png') }}" alt="features-icon"></span>
                                                                </div>
                                                            ...
                                                            <div class="bd-services__features-item">
                                                                <div class="bd-services__features-icon">
                                                                    <span><img src="{{ asset('assets/frontend/img/service/details/feed-icon-02.png') }}" alt="features-icon"></span>
                                                                </div>
                                                                <div class="bd-services__features-content">
                                                            ...
                                                            <div class="bd-services__features-item">
                                                                <div class="bd-services__features-icon">
                                                                    <span><img src="{{ asset('assets/frontend/img/service/details/feed-icon-01.png') }}" alt="features-icon"></span>
                                                                </div>
                                                                <div class="bd-services__features-content">
                                                            ...
                                                            <div class="bd-services__features-item">
                                                                <div class="bd-services__features-icon">
                                                                    <span><img src="{{ asset('assets/frontend/img/service/details/breed-icon-04.png') }}" alt="features-icon"></span>
                                                                </div>
                                                                <div class="bd-services__features-content">
                                                            ...
                                                            <div class="bd-services__features-item">
                                                                <div class="bd-services__features-icon">
                                                                    <span><img src="{{ asset('assets/frontend/img/service/details/breed-icon-02.png') }}" alt="features-icon"></span>
                                                                </div>
                                                                <div class="bd-services__features-content">
                                                    ...
                                                    <div class="bd-services__founder mb-45">
                                                        ...
                                                        <div class="bd-services__founder-icon">
                                                            <img src="{{ asset('assets/frontend/img/service/details/message.png') }}" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="bd-services__details-wrapper mb-60">
                                                    <div class="bd-services__details-thumb w-img mb-50">
                                                        <img src="{{ asset('assets/frontend/img/service-details-02.jpg') }}" alt="service-thumb">
                                                    </div>
                                                    <div class="bd-services__details-content mb-40">
                                                        <div class="bd-services__details-text mb-45">
                                                        ...
                                                        <div class="bd-services__details-features mb-40">
                                                            <div class="bd-services__features-grid">
                                                                ...
                                                                <div class="bd-services__features-item">
                                                                    <div class="bd-services__features-icon">
                                                                        <span><img src="{{ asset('assets/frontend/img/service/details/icon-02.png') }}" alt="features-icon"></span>
                                                                    </div>
                                                                    <div class="bd-services__features-content">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="bd-services__details-wrapper mb-60">
                                                    <div class="bd-services__details-thumb w-img mb-50">
                                                        <img src="{{ asset('assets/frontend/img/dairy-farm-tech-teaser.jpg') }}" alt="service-thumb">
                                                    </div>
                                                    <div class="bd-services__details-content mb-40">
                                                        <div class="bd-services__details-text mb-45">
                                                        ...
                                                        <div class="bd-services__details-features mb-40">
                                                            <div class="bd-services__features-grid">
                                                                ...
                                                                <div class="bd-services__features-item">
                                                                    <div class="bd-services__features-icon">
                                                                        <span><img src="{{ asset('assets/frontend/img/service/details/breed-icon-03.png') }}" alt="features-icon"></span>
                                                                    </div>
                                                                    <div class="bd-services__features-content">
                                                                ...
                                                                <div class="bd-services__features-item">
                                                                    <div class="bd-services__features-icon">
                                                                        <span><img src="{{ asset('assets/frontend/img/service/details/icon-01.png') }}" alt="features-icon"></span>
                                                                    </div>
                                                                    <div class="bd-services__features-content">
                                                                ...
                                                                <div class="bd-services__features-item">
                                                                    <div class="bd-services__features-icon">
                                                                        <span><img src="{{ asset('assets/frontend/img/service/details/info.png') }}" alt="features-icon"></span>
                                                                    </div>
                                                                    <div class="bd-services__features-content">
                                                                ...
                                                                <div class="bd-services__features-item">
                                                                    <div class="bd-services__features-icon">
                                                                        <span><img src="{{ asset('assets/frontend/img/service/details/handle-with-care.png') }}" alt="features-icon"></span>
                                                                    </div>
                                                                    <div class="bd-services__features-content">
                                                                ...
                                                                <div class="bd-services__features-item">
                                                                    <div class="bd-services__features-icon">
                                                                        <span><img src="{{ asset('assets/frontend/img/service/details/tank.png') }}" alt="features-icon"></span>
                                                                    </div>
                                                                    <div class="bd-services__features-content">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="bd-services__details-wrapper mb-60">
                                                        <div class="bd-services__details-thumb w-img mb-50">
                                                            <img src="{{ asset('assets/frontend/img/service-details-04.jpg') }}" alt="service-thumb">
                                                        </div>
                                                        <div class="bd-services__details-content mb-40">
                                                            <div class="bd-services__details-text mb-45">
                                                            ...
                                                            <div class="bd-services__details-features mb-40">
                                                                <div class="bd-services__features-grid">
                                                                    <div class="bd-services__features-item">
                                                                        <div class="bd-services__features-icon">
                                                                            <span><img src="{{ asset('assets/frontend/img/service/details/icon-03.png') }}" alt="features-icon"></span>
                                                                        </div>
                                                                        <div class="bd-services__features-content">
