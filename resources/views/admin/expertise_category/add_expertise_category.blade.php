        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Add New Expertise Category</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Expertise Category</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title">Add New Expertise Category</h4>
                            <hr style="margin-bottom: 50px; background-color: darkgrey;">

                            <form action="{{ route('admin.expertise_category.add_data', base64_encode(1)) }}" method="POST" id="slide_frm" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="image"><strong>Image English</strong> <span style="color:red;">*</span></label>
                                            <input type="file" name="image" id="image" class="form-control" required accept="image/jpeg,image/png" />
                                            @error('image')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
