        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Sale Purchase Option Images</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin_index') }}">Home</a></li>
                        <li class="breadcrumb-item active">View Sale Purchase Slider</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <h4 class="mt-0 header-title">View Sale Purchase Slider</h4>
                                </div>
                                <div class="col-md-2">
                                    <a href="{{ route('admin.option_image.add') }}" class="btn btn-info">Add Slider</a>
                                </div>
                            </div>
                            ...
                            <div class="table-rep-plugin">
                                <div class="table-responsive b-0" data-pattern="priority-columns">
                                    <table id="optionImageTable" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Image 1</th>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" id="btns{{ $i - 1 }}">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li><a href="{{ route('admin.option_image.update', base64_encode($data->id)) }}">Edit</a></li>
                                                        ...
                                                        <div style="display:none" id="cnfbox{{ $i - 1 }}" class="confirmation-box">
                                                            ...
                                                            <form action="{{ route('admin.option_image.delete', base64_encode($data->id)) }}" method="POST" style="display: inline;">
                                                                @csrf
                                                                @method('POST')
