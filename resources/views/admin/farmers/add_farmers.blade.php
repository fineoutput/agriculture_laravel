            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Farmer</h3>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="col-lg-10">
                            <form action="{{ route('admin.farmers.add_data', base64_encode(1)) }}" method="POST" id="slide_frm" enctype="multipart/form-data">
                                @csrf
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="village" class="form-control" placeholder="Enter village" required value="{{ old('village') }}" />
                                                @error('village')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="district" class="form-control" placeholder="Enter district" required value="{{ old('district') }}" />
                                                @error('district')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="Pincode" class="form-control" placeholder="Enter pincode" maxlength="6" minlength="6" required value="{{ old('Pincode') }}" onkeypress="return isNumberKey(event)" />
                                                @error('Pincode')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="phone_number" class="form-control" placeholder="Enter phone number" maxlength="10" minlength="10" required value="{{ old('phone_number') }}" onkeypress="return isNumberKey(event)" />
                                                @error('phone_number')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </td>
