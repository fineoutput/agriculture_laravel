        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">{{ $category_images->name ?? 'Update Category Images' }}</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin_index') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.category_images.view') }}">Category Images</a></li>
                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <!-- Debug Warning -->
                            @if(!$category_images)
                                <div class="alert alert-warning">Category image data not found. Please check the database.</div>
                            @endif

                            <h4 class="mt-0 header-title"><i class="fa fa-image"></i> Update Category Images</h4>
                            <hr style="margin-bottom: 50px; background-color: darkgrey;">

                            <form action="{{ route('admin.category_images.add_data', ['t' => 'update', 'iw' => $idd]) }}" method="POST" id="slide_frm" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if($category_images->image)
                                                <img src="{{ asset($category_images->image) }}" height="50" width="100" alt="English Image" style="margin-top: 10px;">
                                            @else
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if($category_images->image_hindi)
                                                <img src="{{ asset($category_images->image_hindi) }}" height="50" width="100" alt="Hindi Image" style="margin-top: 10px;">
                                            @else
                                                <span style="margin-top: 10px; display: block;">No Image</span>
                                            @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if($category_images->image_punjabi)
                                                <img src="{{ asset($category_images->image_punjabi) }}" height="50" width="100" alt="Punjabi Image" style="margin-top: 10px;">
                                            @else
                                                <span style="margin-top: 10px; display: block;">No Image</span>
                                            @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if($category_images->image_gujrati)
                                                <img src="{{ asset($category_images->image_gujrati) }}" height="50" width="100" alt="Marathi Image" style="margin-top: 10px;">
                                            @else
                                                <span style="margin-top: 10px; display: block;">No Image</span>
                                            @endif
                                            @error('image_gujrati') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-12">
