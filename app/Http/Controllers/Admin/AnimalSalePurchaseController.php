...
use App\Models\AnimalSalePurchase;
use App\Models\Farmer;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Log;

class AnimalSalePurchaseController extends Controller
{
    ...
    {
        $sale_purchase = AnimalSalePurchase::orderBy('id', 'desc')->get();
        $farmer_details = $this->getFarmerDetails($sale_purchase);
        Log::info('All Sale/Purchase Data:', $sale_purchase->toArray());

        return view('admin.animal_sale_purchase.view_salepurchase', [
    ...
    {
        $sale_purchase = AnimalSalePurchase::where('status', 0)->orderBy('id', 'desc')->get();
        $farmer_details = $this->getFarmerDetails($sale_purchase);
    ...
    {
        $sale_purchase = AnimalSalePurchase::where('status', 1)->orderBy('id', 'desc')->get();
        $farmer_details = $this->getFarmerDetails($sale_purchase);
    ...
    {
        $sale_purchase = AnimalSalePurchase::where('status', 2)->orderBy('id', 'desc')->get();
        $farmer_details = $this->getFarmerDetails($sale_purchase);
    ...
    {
        $sale_purchase = AnimalSalePurchase::where('status', 3)->orderBy('id', 'desc')->get();
        $farmer_details = $this->getFarmerDetails($sale_purchase);
    ...
    public function updateSalePurchaseStatus($idd, $t)
    {
        try {
            ...
            $sale_purchase = AnimalSalePurchase::findOrFail($id);
